    ...
    try:
        for size in range(1, st.settings.max_literals + 1):
            ...
            while True:
                ...
                #st.stats.register_program(program, None)
                conf_matrix = reconstruct_conf_matrix(outcome, score, st.settings)
                st.stats.register_program(program, conf_matrix)
                ...
                if best_score is None or score > best_score:
                    ...
                    if outcome == ("all", "none"):
                        ...
                        print(f"⏱️ Time to convergence: {elapsed:.2f}s\n")
